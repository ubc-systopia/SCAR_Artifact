 ...
 * real RSA-4096 BigInteger.modExp loop. Same victim as quickjs_bigint_select_rsa_fr.c;
...
static void profile_select_rsa(void) {
	...
	/* key-pool-style naming, matching quickjs_bigint_select_rsa_fr.c so the same
	 ...
	 * openpgp_bigint_select_rsa.js's KEY_ID mechanism. */
